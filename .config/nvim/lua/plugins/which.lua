return {
    ...
    config = function()
        ...
        wk.add({
            ...
            { "<leader>md", desc = "Delete the current Molten cell" },
            { "<leader>me", desc = "Evaluate an operator selection" },
            { "<leader>mh", desc = "Hide Molten output" },
            { "<leader>mi", desc = "Initialize Molten and pick a kernel" },
            { "<leader>ml", desc = "Evaluate the current line" },
            { "<leader>mo", desc = "Open the current Molten output in a browser" },
            { "<leader>mr", desc = "Restart the active Molten kernel" },
            { "<leader>ms", desc = "Show Molten output" },
            { "<leader>mv", desc = "Evaluate the visual selection", mode = "v" },
